...
SubjectsModule.CourseDropdown = {
     ...
     */
    populateCourseDivisionDropdown: async function() {
     ...
     */
    populateCourseFilter: async function() {
     ...
     */
    populateSubjectSelect: function() {
        ...
        if (window.appData && window.appData.materia) {
            window.appData.materia.forEach(subject => {
                const option = document.createElement('option');
